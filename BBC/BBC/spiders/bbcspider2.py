...
class MySpider(CrawlSpider):
    name = "bbc2"  # unique identifier for the spider
    ...
    def parse_item(self, response):
        ...
        temparticlecontent = sel.xpath('//div[@class="story-body__inner"]//text()').extract()  
        temparticlecontent = re.sub(r'(\n)|(\s{2,})', '', temparticlecontent)
        #item['article_content'] = temparticlecontent.re(r'<[^>]*?>', ' ', str(site[0].extract()))
