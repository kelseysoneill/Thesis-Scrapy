...
class MySpider(CrawlSpider):
    name = "abctest1"  # unique identifier for the spider
    ...
    def parse_item(self, response):
       ...
       # item['article_title'] = sel.xpath('//div[@class="container"]/header/h1/text()').extract()
        ...
        #tem['article_author'] = sel.xpath('//div[@class="article-meta"]/ul/li/div/text()').extract()
        ...
        sample = sel.xpath('//div[@class="article-copy"]/p[descendant-or-self::text()]')
